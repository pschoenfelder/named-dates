...
def test_weekday_less_than_first_of_month():
    ...
    assert day_of_nth_weekday(2015, 10, 0, nth=1) == 5
    assert day_of_nth_weekday(2015, 10, 0, nth=2) == 12
    assert day_of_nth_weekday(2015, 10, 0, nth=3) == 19
    assert day_of_nth_weekday(2015, 10, 0, nth=4) == 26
    with pytest.raises(NoNthWeekdayException):
        day_of_nth_weekday(2015, 10, 0, nth=5)
